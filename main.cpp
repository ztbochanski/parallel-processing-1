...
#pragma omp parallel for default(none) shared(PinAx, PinAy, PinAr, PinBx, PinBy, PinBr, PinCx, PinCy, PinCr, holeaxs, holeays, holears, holebxs, holebys, holebrs, holecxs, holecys, holecrs, stderr) reduction(+ : numSuccesses)
    for (int n = 0; n < NUMTRIALS; n++)
    {
